...
class TestProviderRegistry:
    # gemini-llm360 与 vidu 仅提供视频/图片，elevenlabs 仅提供音频，kling 为仅身份注册（无 models），均跳过文本相关断言
    _TEXT_PROVIDERS = [pid for pid in PROVIDER_REGISTRY if pid not in ("gemini-llm360", "vidu", "elevenlabs", "kling")]
